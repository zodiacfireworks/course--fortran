...
\begin{document}
  ...
  \input{sections/01_punteros}
  \input{sections/02_program_objetos}
  \input{sections/03_topicos_adic}
  \input{sections/04_proyecto4_deriv_integral}

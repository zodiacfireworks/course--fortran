...
\begin{document}
  ...
  \input{sections/00_intro_procedimientos}
  \input{sections/01_subrutinas}
  \input{sections/02_funciones}
  \input{sections/03_utilidades}
  \input{sections/04_modulos}
  \input{sections/05_interfaces_genericas}
  \input{sections/06_proyecto3_fechas_series_tiempo}
